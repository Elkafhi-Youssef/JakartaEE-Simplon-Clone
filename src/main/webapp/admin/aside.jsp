<aside class="w-64 flex-2 min-h-screen bg-red-200" aria-label="Sidebar">
  <div class="overflow-y-auto py-3 px-3 bg-red-200 rounded dark:bg-gray-800">
    ...
    <ul class="space-y-2">
      ...
      <li>
        <a href="<%=url+"StudentServlet/AddStudent"%>" class="flex items-center p-2 text-base font-normal text-blue-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <li>
          <a href="<%=url%>Logout/Admin" class="flex items-center p-2 text-base font-normal text-blue-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
